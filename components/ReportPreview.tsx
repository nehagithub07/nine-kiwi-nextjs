    ...
    <div id="reportPreview" className="report-preview p-4 md:p-6 space-y-6">
      ...
      <Section title="Status">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <Line label="Inspector" value={normalizeString(form?.inspectorName)} />
          <Line label="Supervisor" value={normalizeString(form?.supervisorName)} />
          ...
          <Line label="Phone" value={normalizeString(form?.contactPhone)} />
          <Line label="Email" value={normalizeString(form?.contactEmail)} />
          <Line label="Inspection Date" value={normalizeString(form?.inspectionDate)} />
          <Line label="Observation Time" value={observationTime} />
        </div>
      </Section>
      ...
      {(hasLocationData || hasWeatherData) && (
        <Section title="Location & Weather">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <Line label="Location" value={normalizeString(form?.location)} />
